...
export default async function PrivacyPage({ params }: Props) {
  ...
  const sections: LegalSection[] = locale === "id" ? [
    ...
    { title: "Kontak privasi", paragraphs: ["Untuk pertanyaan atau permintaan privasi, hubungi jonathanfarelemanuel@gmail.com dengan subjek ‘Privacy Request’. Identitas badan hukum akan diperbarui setelah dikonfirmasi secara resmi."] },
  ] : [
    ...
    { title: "Privacy contact", paragraphs: ["For privacy questions or requests, email jonathanfarelemanuel@gmail.com with the subject ‘Privacy Request’. Legal entity details will be updated once officially confirmed."] },
  ];
