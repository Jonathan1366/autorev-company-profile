...
export default async function TermsPage({ params }: Props) {
  ...
  const sections: LegalSection[] = locale === "id" ? [
    ...
    { title: "Kontak", paragraphs: ["Pertanyaan tentang ketentuan ini dapat dikirim ke jonathanfarelemanuel@gmail.com atau melalui 0813 6740 8145. Detail badan hukum, alamat resmi, dan yurisdiksi spesifik akan diperbarui setelah dikonfirmasi."] },
  ] : [
    ...
    { title: "Contact", paragraphs: ["Questions about these terms can be sent to jonathanfarelemanuel@gmail.com or +62 813 6740 8145. Legal entity details, official address, and specific jurisdiction will be updated once confirmed."] },
  ];
